...
const PROTOTYPE_HTML = String.raw`
  ...
  <div class="mobile-nav" id="mobile-nav" hidden><button data-route="home">Portada</button><button data-route="football">Fútbol</button><button data-route="f1">Fórmula 1</button><button data-route="nba">NBA</button></div>
  <main id="contenido" tabindex="-1">
    <section class="view active-view" data-view="home" id="inicio">
      <div class="home-hero"><div class="hero-copy"><p class="overline"><span>EN UNA SOLA CANCHA</span> FÚTBOL + FÓRMULA 1 + NBA</p><h1>Todo el deporte.<br><em>Sin vueltas.</em></h1><p class="hero-lead">Noticias con imágenes licenciadas, resultados por fecha y datos trazables con acceso directo a cada fuente.</p><div class="hero-actions"><button class="primary-action" data-route="football">Explorar fútbol <span>→</span></button><button class="secondary-action" data-route="f1">Entrar a F1 <span>→</span></button><button class="secondary-action nba-action" data-route="nba">Ver NBA <span>→</span></button></div></div><div class="hero-visual"><div class="pitch-lines" aria-hidden="true"><span></span><i></i></div><div class="speed-lines" aria-hidden="true"><i></i><i></i><i></i><i></i></div><span class="hero-label football-label" aria-hidden="true">FÚTBOL</span><span class="hero-label f1-label" aria-hidden="true">F1</span><span class="hero-label nba-label" aria-hidden="true">NBA</span><div class="hero-score"><small>COBERTURA</small><b>03</b><span>DEPORTES</span></div></div></div>
      ...
      <section class="section-wrap latest-section" aria-labelledby="latest-title"><div class="section-head"><div><span class="section-index">01</span><p class="overline">PORTADA</p><h2 id="latest-title">Lo último</h2></div><div class="segmented" role="group" aria-label="Filtrar noticias"><button class="active" data-home-filter="all">Todo</button><button data-home-filter="football">Fútbol</button><button data-home-filter="f1">Fórmula 1</button><button data-home-filter="nba">NBA</button></div></div><div class="news-grid" id="home-news" aria-live="polite"></div></section>
