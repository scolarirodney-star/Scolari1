...
const PROTOTYPE_HTML = String.raw`
  ...
  <header class="site-header">
    <a class="brand" href="#inicio" data-route="home" aria-label="Al Ángulo, portada"><span class="brand-icon">A</span><span><b>AL ÁNGULO</b><small>SPORTS INTELLIGENCE</small></span></a>
  ...
  <main id="contenido" tabindex="-1">
    ...
    <section class="view" data-view="football" hidden>
      <div class="sport-hero football-hero"><div><p class="overline">01 · FÚTBOL</p><h1>La cancha<br>completa.</h1><p>Europa y Sudamérica con noticias, posiciones y resultados por fecha.</p></div><div class="sport-stat"><small>COMPETICIONES</small><b>06</b><span>5 Europa · 1 Sudamérica</span></div></div>
      ...
      <section class="section-wrap football-content"><div class="content-tabs" role="tablist" aria-label="Contenido de fútbol"><button class="active" role="tab" aria-selected="true" data-football-tab="news">Noticias y tabla</button><button role="tab" aria-selected="false" data-football-tab="results">Resultados recientes</button><button role="tab" aria-selected="false" data-football-tab="upcoming">Próximos partidos</button></div><div id="football-news-panel" class="tab-panel"><div class="news-grid" id="football-news"></div><section class="competition-standings" id="football-standings" aria-live="polite"></section></div><div id="football-results-panel" class="tab-panel" hidden><div class="result-filter-bar"><div><p class="overline">RESULTADOS POR FECHA</p><b>Vista general o por club</b></div><label><span>Club</span><select id="result-club-filter"><option value="all">Todos los clubes</option></select></label></div><div class="data-table-wrap" id="football-results"></div></div><div id="football-upcoming-panel" class="tab-panel" hidden><div class="data-table-wrap" id="football-upcoming"></div></div></section>
    </section>
    <section class="view" data-view="f1" hidden>
      <div class="sport-hero formula-hero"><div><p class="overline">02 · FÓRMULA 1</p><h1>Precisión a<br>máxima velocidad.</h1><p>Carreras, pilotos y equipos conectados con la fuente oficial.</p></div><div class="speed-gauge" aria-hidden="true"><span>2026</span><b>F1</b><i></i></div></div>
  ...
  <footer><div class="footer-top"><a class="brand" href="#inicio" data-route="home"><span class="brand-icon">A</span><span><b>AL ÁNGULO</b><small>SPORTS INTELLIGENCE</small></span></a><p>Información deportiva resumida, trazable y conectada con su fuente original.</p><div class="footer-status"><i></i> BETA PÚBLICA</div></div><div class="footer-bottom"><span>© 2026 AL ÁNGULO</span><nav aria-label="Información legal"><button data-legal="legal">Aviso legal</button><button data-legal="privacy">Privacidad</button><button data-legal="cookies">Cookies</button><button data-legal="takedown">Solicitar retirada</button></nav><span>ES · PY</span></div></footer>
