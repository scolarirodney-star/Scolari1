...
export const metadata: Metadata = {
  ...
  title: 'ScolariX | El deporte, sin vueltas',
  description: 'Noticias, resultados y clasificaciones de fútbol y Fórmula 1 con fuentes visibles.',
  openGraph: {
    title: 'ScolariX | El deporte, sin vueltas',
    description: 'Noticias, resultados y clasificaciones de fútbol y Fórmula 1 con fuentes visibles.',
    images: [{ url: 'https://al-angulo-deportes.scolari-rodney.chatgpt.site/og.png', width: 1200, height: 630, alt: 'ScolariX, fútbol y Fórmula 1' }],
  },
  twitter: {
